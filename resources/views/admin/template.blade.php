...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item">
                            <a href="{{ url('master_produk') }}" class="nav-link">
                                <i class="nav-icon fas fa-shopping-cart"></i> &nbsp;<p>Master Produk</p>
                            </a>
                        </li>

                        @if(Auth::user()->roleuser == 1)
                        <li class="nav-item">
                            <a href="{{ url('master_pengguna') }}" class="nav-link">
        ...
        <footer class="main-footer">
            <strong>Copyright &copy; 2022 E-Commerce </strong>
